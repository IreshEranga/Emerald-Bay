const updateTableReservationEmailTemplate = (name, reservationId, date, time, tableNo) => {
    return `
        <p>Dear ${name},</p>
        <p>Your table reservation with ID ${reservationId} has been successfully updated.</p>
...
module.exports = updateTableReservationEmailTemplate;