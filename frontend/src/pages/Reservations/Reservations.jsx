      ...
      <div className="reservations-container">
        ...
        <div className="reservation-categories">
          <div className="reservation-category">
            ...
            <img src={TableReservation} style={{ width: '650px', borderRadius: '50%', alignContent: 'center' }} alt="TableReservation" className="image-hover" />
            <br /><br /><br />
          ...
          <div className="reservation-category">
            <br /><br />
            <h3>EVENTS</h3><br />
            <img src={Events} style={{ width: '650px', borderRadius: '50%', alignContent: 'center' }} alt="Events" className="image-hover" />
            <br /><br /><br />
