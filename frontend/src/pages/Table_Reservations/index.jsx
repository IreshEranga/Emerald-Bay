...
import AddTableReservations from "./AddTableReservations";
import EditTableReservations from "./EditTableReservations";
...
const index = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <EditTableReservations />

      <h1 className="mb-5">Table Reservations</h1>
